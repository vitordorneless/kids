...
<html lang="en">
    <head>
        <meta name="description" content="Kids, gestão em crianças">
        <!-- Twitter meta-->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:site" content="www.kidsescola.com.br">
        <meta property="twitter:creator" content="@vitordornelespimentel">
        <!-- Open Graph Meta-->
        ...
        <link rel="stylesheet" type="text/css" href="css/vali-admin-master/docs/css/main.css">
        <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
        <title>Kids</title>
    </head>
    <body class="app sidebar-mini">
        <header class="app-header"><a class="app-header__logo" href="index.php">Kids</a>
        ...
        <script src="css/vali-admin-master/docs/js/jquery-3.2.1.min.js"></script>
        <script src="css/vali-admin-master/docs/js/popper.min.js"></script>        
        <script src="css/vali-admin-master/docs/js/bootstrap.min.js"></script>
        <script src="css/vali-admin-master/docs/js/main.js"></script>
        <!-- The javascript plugin to display page loading on top-->
        <script src="css/vali-admin-master/docs/js/plugins/pace.min.js"></script>
        <!-- Page specific javascripts-->
        <script type="text/javascript" src="css/vali-admin-master/docs/js/plugins/chart.js"></script>
